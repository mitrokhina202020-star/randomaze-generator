...
- **Два блока кода на выходе** — генерируются одновременно:
  - Полный рандомайзер с описаниями, историей попыток и кнопкой «Сохранить»
  - Упрощённый список (только названия) с возможностью поменять проект
- **Один файл** — без базы данных и сторонних библиотек
